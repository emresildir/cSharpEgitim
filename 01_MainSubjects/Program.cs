...
namespace _01_MainSubjects
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            //customerPhone = "+90 543 405 34 05";
            //customerEmail = "ali_kaya@gmail.com";
            //district = "Çekmeköy";
            //city = "İstanbul";
            ...
            //Console.WriteLine("İletişim Bilgileri: " + customerPhone);
            //Console.WriteLine("EMail Adresi: " + customerEmail);
            //Console.WriteLine("Adres Bilgisi: " + city + " / " + district);
            //Console.WriteLine();
            //Console.WriteLine("------------------------------------------------");
            //Console.WriteLine();
            ...
            //customerSurname = "Kaya";
            //customerPhone = "+90 542 272 92 14";
